...
print("average C: ",Cavg/((time-0.1)/0.1))
print("average D: ",Davg/((time-0.1)/0.1))
print("predicted real value of coefficient C:",realC-(Cavg*errorC))
print("real value: ",coeffsC)
print("predicted real value of coefficient A:",realA+(Aavg*errorA))
print("real value: ",coeffsA)
print("predicted real value of coefficient A:",realB-(Bavg*errorB))
